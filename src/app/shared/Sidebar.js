        ...
        <ul className="nav">
          ...
          <li className={ this.isPathActive('/auth') ? 'nav-item active' : 'nav-item' }>
            ...
            <Collapse in={ this.state.userPagesMenuOpen }>
              <ul className="nav flex-column sub-menu">
                <li className="nav-item"> <Link className={ this.isPathActive('/auth/login') ? 'nav-link active' : 'nav-link' } to="/auth/login"><Trans>Login</Trans></Link></li>
                <li className="nav-item"> <Link className={ this.isPathActive('/auth/register') ? 'nav-link active' : 'nav-link' } to="/auth/register/"><Trans>Register</Trans></Link></li>
                <li className="nav-item"> <Link className={ this.isPathActive('/auth/register-custom') ? 'nav-link active' : 'nav-link' } to="/auth/register-custom"><Trans>Register Custom</Trans></Link></li>
                <li className="nav-item"> <Link className={ this.isPathActive('/auth/forgot-password') ? 'nav-link active' : 'nav-link' } to="/auth/forgot-password"><Trans>Forgot Password</Trans></Link></li>
                <li className="nav-item"> <Link className={ this.isPathActive('/auth/reset-password') ? 'nav-link active' : 'nav-link' } to="/auth/reset-password"><Trans>Reset Password</Trans></Link></li>
                <li className="nav-item"> <Link className={ this.isPathActive('/auth/verification-success') ? 'nav-link active' : 'nav-link' } to="/auth/verification-success"><Trans>Verification Success</Trans></Link></li>
                <li className="nav-item"> <Link className={ this.isPathActive('/auth/lockscreen') ? 'nav-link active' : 'nav-link' } to="/auth/lockscreen"><Trans>Lockscreen</Trans></Link></li>
              </ul>
            </Collapse>
          </li>
